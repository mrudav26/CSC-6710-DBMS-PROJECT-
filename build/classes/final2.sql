...
SELECT QR.*, CRR.Status AS Status
...
Select * from QuoteRequest where NumberOfTrees=1;
...
JOIN OrderOfWork orw ON qr.RequestID = orw.RequestID 
JOIN Bills b ON orw.OrderID = b.OrderID 
JOIN ResponseToBill rb ON b.BillID = rb.BillID 
WHERE orw.Status = 'Finished' 
